...
@TeleOp(name="Teleop LOG Speeds", group="State TEST")
//@Disabled
public class TeleopLogData extends  LinearOpMode {
    ...
    public void runOpMode() {
        ...
        while (opModeIsActive()) {
            ...
            if (gamepad1.dpad_right) {
                robot.drive.robotCentric(0,-.4,-.15);
            } else if (gamepad1.dpad_left) {
                robot.drive.robotCentric(0,.4,.15);
            } else if (gamepad1.right_stick_button) {
                robot.drive.gyroDrivePID(leftY,leftX,0);
            } else {
    ...
    public void RunLog() {
        new Thread(new Runnable()
        {
            ...
            public void run()
            {
                ...
                velocity[0] = robot.DMotor1.getVelocity(AngleUnit.RADIANS);
                robot.DMotor1.setVelocity(100,AngleUnit.DEGREES);
